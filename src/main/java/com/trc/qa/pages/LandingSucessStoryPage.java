...
public class LandingSucessStoryPage extends TestBase{
    ...
    private WebElement YearsFromVasectomy;
    
    @FindBy(xpath="//button[contains(text(),'Send me my Micro-Vas Reversal Guide')]")
