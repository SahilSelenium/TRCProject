...
public class PPReferralPatientsTest extends TestBase {
...
public void Setup(){
	...
	intialization();	
		...
		homepage = login.Login(prop.getProperty("username2"), prop.getProperty("password"));
