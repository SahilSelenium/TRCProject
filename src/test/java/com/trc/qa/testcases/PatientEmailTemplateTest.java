...
public class PatientEmailTemplateTest extends TestBase {
     TestUtil testutil;
	LoginPage loginpage;
	PatientEmailTemplatePage EMailTEMPLATE;
	HomePage homepage;
	String sheetName1 ="AddnewTemplate";
	String sheetName ="AddnewTemplate";
	public PatientEmailTemplateTest(){
		super();
	...
	public void Setup(){
		...
		EMailTEMPLATE =new PatientEmailTemplatePage();
	...
	public void ADDnewTemplate(String NAME, String FromNAme , String FromAddress , String Subject , String Notes) throws Throwable   {
		...
		homepage.SettingsPatientEmailTemplate();
		EMailTEMPLATE.AddnewTemplate(NAME, FromNAme, FromAddress, Subject, Notes);
	}
	...
	public void EditTemplate(String NAME, String FromNAme , String FromAddress , String Subject,String Notes ) throws Throwable   {
		...
		homepage.SettingsPatientEmailTemplate();
		EMailTEMPLATE.EditTemplate(NAME, FromNAme, FromAddress, Subject, Notes);
	}
	
	@Test(priority=3)
	public void delete() throws InterruptedException{
		homepage.SettingsPatientEmailTemplate();
		EMailTEMPLATE.Templatedelete();
